function RAD3input(xmax,f,mumax,kd,xfirststage, RA, D3, RAmin, D3min,td)
...
[T, X] = ode45(@(t,x) RAD3model1(t,x,xmax,f,mumax,kd,RA,D3,RAmin,D3min,td), [0,145], initval,options);
hold on
XR = X(:,1);
X2 = X(:, 2);
X3 = X(:, 3);
